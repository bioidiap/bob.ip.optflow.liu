...
project = u'xbob.ip.optflow.liu'
import time
copyright = u'%s, Idiap Research Institute' % time.strftime('%Y')

# Grab the setup entry
distribution = pkg_resources.require('xbob.ip.optflow.liu')[0]
...
#html_short_title = 'xbob_ip_optflow_liu'
...
htmlhelp_basename = 'xbob_ip_optflow_liu_doc'
...
latex_documents = [
  ('index', 'xbob_ip_optflow_liu.tex', u'Python bindings to the optical flow framework by C. Liu', u'Biometrics Group, Idiap Research Institute', 'manual'),
]
...
man_pages = [
    ('index', 'xbob_ip_optflow_liu', u'Python bindings to the optical flow framework by C. Liu', [u'Idiap Research Institute'], 1)
]
