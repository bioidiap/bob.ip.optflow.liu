...
.. image:: http://img.shields.io/badge/docs-v2.0.17-yellow.svg
   :target: https://www.idiap.ch/software/bob/docs/bob/bob.ip.optflow.liu/v2.0.17/index.html
.. image:: http://img.shields.io/badge/docs-latest-orange.svg
   :target: https://www.idiap.ch/software/bob/docs/bob/bob.ip.optflow.liu/master/index.html
.. image:: https://gitlab.idiap.ch/bob/bob.ip.optflow.liu/badges/v2.0.17/build.svg
   :target: https://gitlab.idiap.ch/bob/bob.ip.optflow.liu/commits/v2.0.17
.. image:: https://gitlab.idiap.ch/bob/bob.ip.optflow.liu/badges/v2.0.17/coverage.svg
   :target: https://gitlab.idiap.ch/bob/bob.ip.optflow.liu/commits/v2.0.17
